    ...
    <aside className="w-80 h-full bg-[#1f1f1f] border-r border-gray-800 flex flex-col">
      ...
      <div className="flex-1 flex flex-col min-h-0">
              ...
              {folders?.map((folder) => (
                <li key={folder.id}>
                  ...
                  >
                    <div className="flex items-center gap-2">
                      <span
                        className={`w-1.5 h-6 rounded-full ${folder.color}`}
                      />
        ...
        <div className="p-3 border-t border-gray-800">
          <button
            type="button"
            className="w-full flex items-center justify-center gap-2 bg-green-500 text-black font-medium rounded-md py-2 hover:bg-green-600 transition"
          >
            <span>＋</span>
            <span>New chat</span>
          </button>
